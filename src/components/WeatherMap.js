...
const WeatherMap = ({ city, onLocationSelect }) => {
  ...
  if (!defaultCity?.lat || !defaultCity?.lon) {
    return (
      ...
      >
        <div style={{ fontSize: '24px', fontWeight: '600' }}>Loading map...</div>
      </motion.div>
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        🗺️ Click anywhere on the map to get weather data for that location
      </motion.div>
      ...
      <MapContainer
        ...
        zoom={10}
        style={{ height: 500, width: '100%', borderRadius: '28px' }}
      ...
      >
        ...
        {/* Default city marker */}
        <Marker position={[defaultCity.lat, defaultCity.lon]}>
          <Popup>
            <div style={{ 
              color: 'var(--color-text)', 
              fontWeight: '600',
                ...
                {selectedLocation.weather && (
                  <div>
                    ...
                    <div style={{ 
                      ...
                      {selectedLocation.weather.weather[0].main}
                    </div>
                    <div style={{ 
                      fontSize: '12px', 
                      color: 'var(--color-text-secondary)'
                    }}>
                      Feels like: {Math.round(selectedLocation.weather.main.feels_like)}°C
                    </div>
                  </div>
                )}
              </motion.div>
